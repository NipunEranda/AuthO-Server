...
export default {
  ...
  mounted: async function () {
    ...
    console.log(`https://${window.location.host}/.netlify/functions/auth/v1/authorize?client_id=${params.client_id}&redirect_uri=${params.redirect_uri}&response_type=${params.response_type}&state=${params.state}&user=${this.user.sub}`);
